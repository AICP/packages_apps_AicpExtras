...
public class Lockscreen extends BaseSettingsFragment implements
    ...
    private static final int TEXT_CLOCK_STYLE = 14;
    ...
    private void updateFontSizeMax(int clockStyle){
        if (clockStyle == TEXT_CLOCK_STYLE) {
    ...
    public void onResume() {
        super.onResume();
        updateFontSizeMax(Settings.System.getIntForUser(getActivity().getContentResolver(),
                Settings.System.LOCKSCREEN_CLOCK_SELECTION, 0, UserHandle.USER_CURRENT));
    }
}
