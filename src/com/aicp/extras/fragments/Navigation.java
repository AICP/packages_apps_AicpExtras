...
public class Navigation extends BaseSettingsFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final boolean hwkeysDisabled = Settings.Secure.getIntForUser(
                    getContentResolver(), Settings.Secure.HARDWARE_KEYS_DISABLE,
                    mNeedsNavbar ? 1 : 0, UserHandle.USER_CURRENT) != 0;
        ...
        if (!mHwKeysSupported && hwkeysDisabled) {
    ...
    private void updateWakeVisibility(boolean visible) {
        if (mWakeKeysCategory != null) mWakeKeysCategory.setVisible(visible);
    }
