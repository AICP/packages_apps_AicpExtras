...
import org.aicp.gear.preference.SecureSettingMasterSwitchPreference
...
class Spoofing : BaseSettingsFragment(), DialogInterface.OnClickListener, DialogInterface.OnDismissListener, Preference.OnPreferenceChangeListener {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        mEnableSpoofing = prefSet.findPreference<SecureSettingMasterSwitchPreference>(Const.SPOOFING_OPT_IN)!!
    ...
    override fun onClick(dialog: DialogInterface?, which: Int) {
        if (which == DialogInterface.BUTTON_POSITIVE) {
            mOkClicked = true
            mPrefs.edit().putBoolean(Const.SPOOFING_OPT_IN, true).apply()
        } else {
            mOkClicked = false
            mEnableSpoofing.isChecked = false
        }
