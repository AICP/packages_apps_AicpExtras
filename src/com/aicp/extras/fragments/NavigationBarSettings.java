...
public class NavigationBarSettings extends BaseSettingsFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final PreferenceCategory layoutCategory = (PreferenceCategory)
                findPreference(CATEGORY_LAYOUT);
        ...
        if (navigationBarEnabled && !NavUtils.isEdgeToEdgeEnabled(getContext())) {    //no gesture navigation enabled
            ...
            mAppSwitchCategory.setVisible(navigationMode3Button);
        } else {        // gesture navigation enabled
            mHomeCategory.setVisible(false);
            mBackCategory.setVisible(false);
            mAppSwitchCategory.setVisible(false);
        }
//        mHomeCategory.setVisible(navigationBarEnabled && !NavUtils.isEdgeToEdgeEnabled(getContext()));
//        mBackCategory.setVisible(navigationBarEnabled && !NavUtils.isEdgeToEdgeEnabled(getContext()));
//        mAppSwitchCategory.setVisible(navigationBarEnabled && navigationMode3Button);
    }
