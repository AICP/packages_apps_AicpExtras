...
*/
    ...
    private static final String DESKTOP_MODE_SYSPROP = "canInternalDisplayHostDesktops";
    private static final String PROP_REQUIRED_FOR_DESKTOP_MODE = "isDesktopModeSupported";
...
*/
        ...
        mDesktopModePref.setChecked(!SystemProperties.getBoolean(
                DESKTOP_MODE_SYSPROP, false /* default */));
        mDesktopModePref.setOnPreferenceChangeListener(this);
        Util.requireProp(getActivity(), mDesktopModePref, PROP_REQUIRED_FOR_DESKTOP_MODE, false /* default */, true);
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mDesktopModePref) {
            ...
            SystemProperties.set(DESKTOP_MODE_SYSPROP, isDisabled ? "1" : "0");
