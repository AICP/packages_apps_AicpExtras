...
public class ReportingServiceManager extends BroadcastReceiver {
    ...
    public static void setAlarm(Context context, long millisFromNow) {
        ...
        Log.d(
                Const.TAG,
                "[setAlarm] Next sync attempt in : " + millisFromNow / MILLIS_PER_HOUR + " hours");
    ...
    private static void getUserResponse(Context context, boolean promptUser) {
        // promptUser is called through a service because it cannot be called from a
        // BroadcastReceiver
    ...
    public static void launchService(Context context, boolean force) {
        ...
        if (!force) {
            ...
            if (timeElapsed < UPDATE_INTERVAL) {
                ...
                Log.d(
                        Const.TAG,
                        "Waiting for next sync : " + timeLeft / MILLIS_PER_HOUR + " hours");
                return;
            }
        }
