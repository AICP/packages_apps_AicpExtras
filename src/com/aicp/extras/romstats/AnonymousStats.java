...
public class AnonymousStats extends BaseSettingsFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPersistentOptout =
                (SwitchPreference) prefSet.findPreference(Const.ANONYMOUS_OPT_OUT_PERSIST);
        ...
        if (lastCheck > 1) {
            ...
            String lastCheckStr =
                    DateFormat.getDateTimeInstance(DateFormat.MEDIUM, DateFormat.SHORT)
                            .format(new java.util.Date(lastCheck));
            ...
            if (nextCheck > 0) {
                String nextAlarmStr =
                        DateFormat.getDateTimeInstance(DateFormat.MEDIUM, DateFormat.SHORT)
                                .format(new java.util.Date(nextCheck));
                nextAlarmStr =
                        getResources().getString(R.string.next_report_on) + ": " + nextAlarmStr;
        ...
        mPrefHolder.setSummary(
                getResources()
                        .getQuantityString(R.plurals.reporting_interval_days, tFrame, tFrame));
    }
            ...
            if (mEnableReporting.isChecked()) {
                ...
                mOkDialog =
                        new AlertDialog.Builder(getActivity())
                                .setMessage(
                                        this.getResources()
                                                .getString(R.string.anonymous_statistics_warning))
