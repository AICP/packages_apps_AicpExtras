	...
	public static final String TAG = "ROMStats";
        ...
        // first try to get legacy device Id
            try {
                ...
                String device_id = tm.getDeviceId(); // oder getDeviceId() auf älteren Versionen
	    ...
	    // second try to get IMEI
            try {
                TelephonyManager tm = (TelephonyManager) ctx.getSystemService(Context.TELEPHONY_SERVICE);
                String imei = tm.getImei(); // oder getDeviceId() auf älteren Versionen
