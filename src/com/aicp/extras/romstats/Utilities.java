...
public class Utilities {
    ...
    public static String getUniqueID(Context ctx) {
        ...
        if (device_id == null) {
            ...
            try {
                String wifiMac =
                        new String(NetworkInterface.getByName(wifiInterface).getHardwareAddress());
    ...
    /**
     * Gets the Ask First value 0: RomStats will behave like CMStats, starts reporting automatically
     * after the tframe (default) 1: RomStats will behave like the old CMStats, asks the user on
     * first boot
     *
     * @return boolean
     */
    ...
    /**
     * @param context
     * @return false: opt out cookie not present, work normally true: opt out cookie present,
     *     disable and close
     */
    public static boolean persistentOptOut(Context context) {
        ...
        Log.d(
                Const.TAG,
                "[checkPersistentOptOut] Check prefs exist: "
                        + prefs.contains(Const.ANONYMOUS_OPT_IN));
        if (!prefs.contains(Const.ANONYMOUS_OPT_IN)) {
            ...
            if (cookieFile.exists()) {
                ...
                Log.d(
                        Const.TAG,
                        "[checkPersistentOptOut] Persistent cookie exists -> Disable everything");
