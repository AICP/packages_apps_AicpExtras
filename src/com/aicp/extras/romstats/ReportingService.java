...
public class ReportingService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (canReport) {
            ...
            if (AnonymousStats.getNextJobId(this) == -1) {
                // if we've filled up to the threshold, we may have some stale job queue ids, purge
                // them
            ...
            // set job type
            aicpBundle.putInt(
                    StatsUploadJobService.KEY_JOB_TYPE, StatsUploadJobService.JOB_TYPE_AICP);
    ...
    private void promptUser() {
        ...
        PendingIntent pendingIntent =
                PendingIntent.getActivity(getApplicationContext(), 0, mainActivity, 0);
