...
public class SmartbarSettings extends BaseSettingsFragment {
    ...
    private static final String CONFIG_STORAGE =
            Environment.getExternalStorageDirectory() + File.separator + "smartbar_configs";
    ...
    private static final String PREF_SMARTBAR_LONGPRESS_DELAY = "smartbar_longpress_delay";
    private static final String PREF_SMARTBAR_BUTTON_ANIMATION_STYLE =
            "smartbar_button_animation_style";
    private static final String PREF_SMARTBAR_IME_HINT_MODE = "smartbar_ime_hint_mode";
    private static final String PREF_SMARTBAR_CONTEXT_MENU_MODE = "smartbar_context_menu_mode";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSmartBarContext =
                (SecureSettingIntListPreference) findPreference(PREF_SMARTBAR_CONTEXT_MENU_MODE);
        mImeActions = (SecureSettingIntListPreference) findPreference(PREF_SMARTBAR_IME_HINT_MODE);
        mButtonAnim =
                (SecureSettingIntListPreference)
                        findPreference(PREF_SMARTBAR_BUTTON_ANIMATION_STYLE);
        mButtonLongpressDelay =
                (SecureSettingIntListPreference) findPreference(PREF_SMARTBAR_LONGPRESS_DELAY);
        mSmartBarCustomIconSize =
                (SecureSettingSeekBarPreference) findPreference(PREF_SMARTBAR_CUSTOM_ICON_SIZE);
        mButtonsAlpha = (SecureSettingSeekBarPreference) findPreference(PREF_NAVBAR_BUTTONS_ALPHA);
                                ...
                                public void onClick(DialogInterface dialog, int item) {
                                    ...
                                    try {
                                        ...
                                        resultMsg =
                                                getString(
                                                        R.string
                                                                .smartbar_config_restore_success_toast);
                                    } catch (Exception e) {
                                        resultMsg =
                                                getString(
                                                        R.string
                                                                .smartbar_config_restore_error_toast);
                                    }
                                ...
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    ...
                                    try {
                                        ...
                                        resultMsg =
                                                getString(
                                                        R.string
                                                                .smartbar_config_backup_success_toast);
                                    } catch (Exception e) {
                                        resultMsg =
                                                getString(
                                                        R.string
                                                                .smartbar_config_backup_error_toast);
                                    }
                                    Toast.makeText(getActivity(), resultMsg, Toast.LENGTH_SHORT)
                                            .show();
                                }
    ...
    private void resetSmartbar() {
        ArrayList<ButtonConfig> buttonConfigs =
                Config.getDefaultConfig(
                        getActivity(), ActionConstants.getDefaults(ActionConstants.SMARTBAR));
        Config.setConfig(
                getActivity(),
        ...
        Settings.Secure.putInt(getContentResolver(), Settings.Secure.SMARTBAR_CONTEXT_MENU_MODE, 0);
        mSmartBarContext.setValue(String.valueOf(0));

        Settings.Secure.putInt(getContentResolver(), Settings.Secure.SMARTBAR_IME_HINT_MODE, 0);
        mImeActions.setValue(String.valueOf(0));

        Settings.Secure.putInt(
                getContentResolver(), Settings.Secure.SMARTBAR_BUTTON_ANIMATION_STYLE, 0);
        mButtonAnim.setValue(String.valueOf(0));

        Settings.Secure.putInt(getContentResolver(), Settings.Secure.NAVBAR_BUTTONS_ALPHA, 255);
        mButtonsAlpha.setValue(255);

        Settings.Secure.putInt(getContentResolver(), Settings.Secure.SMARTBAR_LONGPRESS_DELAY, 0);
        mButtonLongpressDelay.setValue(String.valueOf(0));

        Settings.Secure.putInt(getContentResolver(), Settings.Secure.SMARTBAR_CUSTOM_ICON_SIZE, 60);
    ...
    static class ConfigAdapter extends ArrayAdapter<File> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (name.startsWith(SMARTBAR_CONFIGS_PREFIX)) {
                name =
                        f.getName()
                                .substring(SMARTBAR_CONFIGS_PREFIX.length(), f.getName().length());
            }
    ...
    static String getCurrentConfig(Context ctx) {
        String config =
                Settings.Secure.getStringForUser(
                        ...
                        ActionConstants.getDefaults(ActionConstants.SMARTBAR).getUri(),
    ...
    public static ArrayList<File> getConfigFiles(String path) {
        ...
        for (File tmp :
                dir.listFiles(new StartsWithFilter(new String[] {SMARTBAR_CONFIGS_PREFIX}))) {
            list.add(tmp);
        }
        return list;
    }
