        ...
        if (resultCode == Activity.RESULT_OK && requestCode == 69) {
            ...
            try {
                if (ActionUtils.isBitmapAllowedSize(
                        ...
                        File dir =
                                new File(
                                        Environment.getExternalStorageDirectory()
                                                ...
                                                + "dui_icons");
                        dir.mkdirs();
                        String fileName = "dui_icons_" + String.valueOf(System.currentTimeMillis());
                        ;
                        Uri newUri = ImageHelper.addBitmapToStorage(dir, fileName, b);
                        if (newUri == null) {
                            Toast.makeText(
                                            this,
                                            getString(R.string.invalid_icon_from_uri),
                                            Toast.LENGTH_SHORT)
                                    .show();
                            ...
                            resultIntent.putExtra(
                                    ActionUtils.INTENT_EXTRA_RESULT, Activity.RESULT_OK);
                    ...
                    Toast.makeText(
                                    this,
                                    getString(R.string.image_exceeds_max_allowed_size),
                                    Toast.LENGTH_SHORT)
                            .show();
                    sendCancelResultAndFinish();
                }
