...
abstract class BaseSettingsFragment : AicpPreferenceFragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState != null) {
            mPreferenceHighlighted = savedInstanceState.getBoolean(SAVE_HIGHLIGHTED_KEY, false)
        }
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        outState.putBoolean(SAVE_HIGHLIGHTED_KEY, mAdapter?.isHighlightRequested() ?: false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        val listView = view.findViewById<RecyclerView>(android.R.id.list)
        listView?.let { mAdapter?.requestHighlight(view, it) }
    }

    override fun onCreateAdapter(preferenceScreen: PreferenceScreen): Adapter<*> {
        val args = arguments
        val highlightKey = args?.getString(SettingsActivity.EXTRA_PREFERENCE_KEY) ?: ""
        mAdapter = HighlightablePreferenceGroupAdapter(preferenceScreen, highlightKey, mPreferenceHighlighted)
        return mAdapter!!
    }
