...
public class WakeLockBlocker extends SubActivity {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mBlockerEnabled = (Switch) findViewById(
                R.id.wakelock_blocker_switch);
        mWakeLockList = (ListView) findViewById(
                R.id.wakelock_list);
        mWakeLockListHeader = (TextView) findViewById(
                R.id.wakelock_list_header);

        mListAdapter = new WakeLockListAdapter(mContext, android.R.layout.simple_list_item_multiple_choice,
                mSeenWakeLocks);
