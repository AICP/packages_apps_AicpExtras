...
import com.aicp.extras.search.Searchable.SearchIndexProvider;
 ...
 */
public class AeSearchIndexablesProvider extends SearchIndexablesProvider {

    private static final String TAG = AeSearchIndexablesProvider.class.getSimpleName();
    ...
    public Cursor queryXmlResources(String[] strings) {
        ...
        for (String key : keys) {
            ...
            ref[COLUMN_INDEX_XML_RES_INTENT_TARGET_PACKAGE] = AE_ACTIVITY.getPackageName();
            ref[COLUMN_INDEX_XML_RES_INTENT_TARGET_CLASS] = AE_ACTIVITY.getClassName();
            cursor.addRow(ref);
        }
        return cursor;
        ...
        for (String key : keys) {
            ...
            for (SearchIndexableRaw raw : rawList) {
                ...
                ref[COLUMN_INDEX_RAW_ICON_RESID] = raw.iconResId > 0 ? raw.iconResId :
                        (i.getIconRes() > 0 ? i.getIconRes() : R.mipmap.ic_launcher);
                ...
                ref[COLUMN_INDEX_RAW_INTENT_TARGET_PACKAGE] = raw.intentTargetPackage != null ?
                        raw.intentTargetPackage : AE_ACTIVITY.getPackageName();
                ref[COLUMN_INDEX_RAW_INTENT_TARGET_CLASS] = raw.intentTargetClass != null ?
                        raw.intentTargetClass : AE_ACTIVITY.getClassName();
