...
public abstract class HAFRAppChooserDialog extends Dialog {
    ...
    public HAFRAppChooserDialog(Context context) {
        ...
        dAdapter =
                new HAFRAppChooserAdapter(context) {
                    @Override
        ...
        dListView.setOnItemClickListener(
                new OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> av, View v, int pos, long id) {
                        HAFRAppChooserAdapter.AppItem info =
                                (HAFRAppChooserAdapter.AppItem) av.getItemAtPosition(pos);
        ...
        dSearch.setOnEditorActionListener(
