...
class StatusBarLogoStylePreference(context: Context, attrs: AttributeSet) :
    ...
    init {
        mEntries = context.resources.getStringArray(R.array.status_bar_logo_style_entries)
        mEntryValues = context.resources.getStringArray(R.array.status_bar_logo_style_values)
    }
    ...
    private fun getLogoDrawableForStyle(styleIndex: Int): Drawable? {
    ...
    override fun onClick() {
        ...
        listView.adapter =
            LogoStyleAdapter(context, mEntries, mEntryValues, this, selectedIndex)
    ...
    private class LogoStyleAdapter(
        context: Context,
        private val mEntries: Array<String>,
        private val mEntryValues: Array<String>,
        private val mPreference: StatusBarLogoStylePreference,
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
            ...
            val d = mPreference.getLogoDrawableForStyle(styleIndex)
    ...
    companion object {
        ...
        private val SYSTEMUI_LOGO_DRAWABLES = arrayOf(
            ...
            "ic_human_male",
            "ic_human_female",
            "ic_human_male_female",
            "ic_gender_male",
            "ic_gender_female",
            "ic_gender_male_female",
            "ic_guitar_electric"
        )
    }
}
