...
class StatusBarVowifiStylePreference(context: Context, attrs: AttributeSet) :
    ...
    init {
        mEntries = context.resources.getStringArray(R.array.vowifi_icon_style_array)
        mEntryValues = context.resources.getStringArray(R.array.vowifi_icon_style_values)
    }
    ...
    private fun getVowifiDrawableForStyle(styleIndex: Int): Drawable? {
    ...
    override fun onClick() {
        ...
        listView.adapter =
            VowifiStyleAdapter(context, mEntries, mEntryValues, this, selectedIndex)
    ...
    private class VowifiStyleAdapter(
        context: Context,
        private val mEntries: Array<String>,
        private val mEntryValues: Array<String>,
        private val mPreference: StatusBarVowifiStylePreference,
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
            ...
            val d = mPreference.getVowifiDrawableForStyle(styleIndex)
    ...
    companion object {
        ...
        private const val SETTING_KEY = "vowifi_icon_style"
