...
public class MasterSwitchPreferenceDependencyHandler {
    ...
    private static final String TAG = MasterSwitchPreferenceDependencyHandler.class.getSimpleName();
    ...
    private static class PreferenceStoreControl implements PreferenceControl {
        ...
        public PreferenceStoreControl(
                String key, int group, boolean defaultValue, PreferenceDataStore preferenceStore) {
            mKey = key;
            mGroup = group;
    ...
    public boolean isAnotherEnabled(int groupId, String preferenceKey) {
        ...
        if (groupList == null) {
            Log.e(
                    TAG,
                    "inconsistent master switch dependency handler: canDisable called for "
                            + "unregistered group "
                            + groupId
                            + " ("
                            + preferenceKey
    ...
    public void onEnablePref(int groupId, String preferenceKey) {
        ...
        if (groupList == null) {
            Log.e(
                    TAG,
                    "inconsistent master switch dependency handler: onEnablePref called for "
                            + "unregistered group "
                            + groupId
                            + " ("
                            + preferenceKey
    ...
    public String[] getSystemSettingsForGroup(int groupId) {
        ...
        if (groupList == null) {
            Log.e(
                    TAG,
                    "inconsistent master switch dependency handler: getSystemSettingForGroup "
                            + "called for unregistered group "
                            + groupId);
            return new String[0];
        }
    ...
    public String[] getSecureSettingsForGroup(int groupId) {
        ...
        if (groupList == null) {
            Log.e(
                    TAG,
                    "inconsistent master switch dependency handler: getSecureSettingForGroup "
                            + "called for unregistered group "
                            + groupId);
            return new String[0];
        }
    ...
    public String[] getGlobalSettingsForGroup(int groupId) {
        ...
        if (groupList == null) {
            Log.e(
                    TAG,
                    "inconsistent master switch dependency handler: getGlobalSettingForGroup "
                            + "called for unregistered group "
                            + groupId);
            return new String[0];
        }
    ...
    public static void showConfirmDisableDialog(
        ...
        new AlertDialog.Builder(context)
                ...
                .setPositiveButton(R.string.switch_disable_warning_continue, continueButtonListener)
                .setNegativeButton(R.string.switch_disable_warning_cancel, cancelButtonListener)
                .setOnCancelListener(
