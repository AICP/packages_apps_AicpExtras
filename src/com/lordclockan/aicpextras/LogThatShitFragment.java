            ...
            if (preference == mLogcat) {
                ...
                switch (value) {
                    case 1:
                        makeLogcat();
                        try {
                            sharingIntentString = "Logcat:/n" + Helpers.readStringFromFile(logcatHasteKey);
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                        break;
                    case 4:
                        makeKmsg();
                        try {
                            sharingIntentString = "Kmsg:/n" + Helpers.readStringFromFile(kmsgHasteKey);
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                        break;
                    case 8:
                        makeDmesg();
                        try {
                            sharingIntentString = "Dmesg:/n" + Helpers.readStringFromFile(dmesgHasteKey);
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                        break;
                    case 5:
                        ...
                        try {
                            sharingIntentString = "Logcat:/n" + Helpers.readStringFromFile(logcatHasteKey) +
                                    "/nKmsg:/n" + Helpers.readStringFromFile(kmsgHasteKey);
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                        break;
                    case 9:
                        ...
                        try {
                            sharingIntentString = "Logcat:/n" + Helpers.readStringFromFile(logcatHasteKey) +
                                    "/nDmesg:/n" + Helpers.readStringFromFile(dmesgHasteKey);
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                        break;
