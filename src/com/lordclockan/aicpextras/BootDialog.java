...
public class BootDialog extends AppCompatActivity {
    ...
    public static class BootDialogFragment extends PreferenceFragment
        ...
        static final int DEFAULT_BOOT_DIALOG_BG_COLOR = 0xFFFFFFFF;
        static final int DEFAULT_BOOT_DIALOG_STROKE_COLOR = 0xFF01579b;
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            String dialogHexColor = String.format("#%08x", (0xFFFFFFFF & dialogBgColor));
            ...
            String dialogStrokeHexColor = String.format("#%08x", (0xFF01579b & dialogStrokeIntColor));
            ...
            int dialogStrokeThickness = Settings.System.getInt(resolver,
                    Settings.System.BOOT_DIALOG_STROKE_THICKNESS, 5);
            ...
            int dialogCornerRadius = Settings.System.getInt(resolver,
                    Settings.System.BOOT_DIALOG_CORNER_RADIUS, 20);
        ...
        public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen,
            ...
            if (preference.getKey().equals(PREF_BOOT_DIALOG_TEST)) {
                ...
                dialogGd.setStroke(Settings.System.getInt(resolver,
                        ...
                        Settings.System.BOOT_DIALOG_STROKE_COLOR, 0xFF01579b));
