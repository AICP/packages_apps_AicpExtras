...
public class RecentsPanelFragment extends Fragment {
    ...
    public static class SettingsPreferenceFragment extends PreferenceFragment
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            mRecentsFullScreenClock.setChecked(Settings.System.getInt(resolver,
            ...
            mRecentsFullScreenDate.setChecked(Settings.System.getInt(resolver,
        ...
        public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
            ContentResolver resolver = getActivity().getContentResolver();
            boolean value;
            if (preference == mRecentsFullScreenClock) {
                value = mRecentsFullScreenClock.isChecked();
                Settings.System.putInt(resolver, Settings.System.RECENTS_FULL_SCREEN_CLOCK, value ? 1 : 0);
                return true;
            } else if (preference == mRecentsFullScreenDate) {
                value = mRecentsFullScreenDate.isChecked();
                Settings.System.putInt(resolver, Settings.System.RECENTS_FULL_SCREEN_DATE, value ? 1 : 0);
                return true;
            }
            return false;
        }
