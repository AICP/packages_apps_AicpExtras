...
public class AboutFragment extends Fragment {
    ...
    public static class SettingsPreferenceFragment extends PreferenceFragment {
        ...
        private File logcatFile = new File(sdCardDirectory, "aicp_logcat.txt");
        private File hasteKey = new File(sdCardDirectory, "haste_key");
        ...
        public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
            if (preference == mGcommunity) {
                ...
                Shell.SU.run("logcat -d > " + LOGCAT_FILE +
                        "&& curl -s -X POST -T " + LOGCAT_FILE + " " + AICP_HASTE +
                        " | cut -d'\"' -f4 | echo \"http://haste.aicp-rom.com/$(cat -)\" > " + HASTE_KEY);
                logcatDialog();
            } else {
        ...
        public void logcatDialog() {
            ...
            builder.setPositiveButton(R.string.make_logcat, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface arg0, int arg1) {
                    ...
                    sharingIntent.putExtra(android.content.Intent.EXTRA_TEXT, readHasteKey(getContext(), HASTE_KEY));
        ...
        private String readHasteKey(Context context, String fileName) {
            if (context == null) {
                return null;
            }
